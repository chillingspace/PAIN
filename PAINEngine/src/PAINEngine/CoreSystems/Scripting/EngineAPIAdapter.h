...
namespace PAIN {
    ...
    public:
        ...
        void SetModelByName(entt::entity entityId, const std::string& virtual_path) override;
        ...
        std::optional<std::tuple<float, float, float>> GetUIFollowOffset(entt::entity uiEntityId) override;
