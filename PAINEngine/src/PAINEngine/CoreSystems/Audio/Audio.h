...
namespace PAIN {
    namespace Audio {
        ...
        public:
            ...
            // 3D positional SFX
            virtual std::optional<AudioChannelId> playSFXAt(const std::string& filename,
                const glm::vec3& pos,
                float volumeDb = 0.0f,
                bool looping = false,
                float minDist = MIN_DISTANCE_3D,
            ...
            // Random SFX from list (C++ randomization)
            virtual std::optional<AudioChannelId> playRandomFromList(
            ...
            virtual float getGroupVolumeDb(const char* group) = 0;
            ...
            virtual bool checkGroupIsPlaying(const char* group) = 0;
            virtual bool checkGroupPaused(const char* group) = 0;
            virtual void pauseGroup(const char* group) = 0;
            virtual void stopGroup(const char* group) = 0;
            virtual void resumeGroup(const char* group) = 0;
