...
private:
  ...
  struct MaterialKey {
    ...
    bool operator!=(const MaterialKey &mk) { return !(*this == mk); }
  };
...
public:
  ...
  unsigned int getFinalFbo() const { return final_fbo; }

  unsigned int getFinalTexture() const { return final_texture; }
