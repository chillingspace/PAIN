...
namespace PAIN {
    ...
    int ImGuiLayer::imguiKeyMapping(int code) {
    ...
    void ImGuiLayer::handleKeyEvents(ImGuiIO& io, Event::Event& event) {
    ...
    void ImGuiLayer::handleMouseEvents(ImGuiIO& io, Event::Event& event) {
        //Create event dispatcher
        Event::Dispatcher dispatcher(event);
    ...
    void ImGuiLayer::handleWindowEvents(ImGuiIO& io, Event::Event& event) {
