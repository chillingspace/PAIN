...
// inline void
// RegisterBoundingVolumeUI_UNUSED(PAIN::Editor::Panel::ComponentsPanel& panel)
// {
//    // Register a lambda function to draw the UI for cBoundingVolume
//    panel.registerCompUIFunc<cBoundingVolume>([](PAIN::Editor::Panel::ComponentsPanel&
//    comp_panel, cBoundingVolume& volume) {
...
//        ImGui::InputFloat3("Min##Local", glm::value_ptr(volume.localAABB.min),
//        "%.3f", ImGuiInputTextFlags_ReadOnly);
//        ImGui::InputFloat3("Max##Local", glm::value_ptr(volume.localAABB.max),
//        "%.3f", ImGuiInputTextFlags_ReadOnly);

//        ImGui::Spacing();

//        ImGui::Text("World AABB:");
//        ImGui::InputFloat3("Min##World", glm::value_ptr(volume.worldAABB.min),
//        "%.3f", ImGuiInputTextFlags_ReadOnly);
//        ImGui::InputFloat3("Max##World", glm::value_ptr(volume.worldAABB.max),
//        "%.3f", ImGuiInputTextFlags_ReadOnly);
...
// Reflection
// NOTE: bvhNodeIndex and needsUpdate are intentionally NOT serialized.
// These are runtime/transient state:
// - bvhNodeIndex is only valid for a specific BVH build and becomes stale after
// reload
