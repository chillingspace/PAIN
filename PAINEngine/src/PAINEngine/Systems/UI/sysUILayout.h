/*****************************************************************//**
 * \file   sysUILayout.h
 * \brief  UI layout system declarations
 *
...
namespace PAIN {
	namespace UI {
		...
		private:
			...
			// Floating labels 
			void updateFloatingLabels(entt::registry& registry, const glm::mat4& view,
			...
			glm::vec2 worldToScreen(const glm::vec3& world_pos, const glm::mat4& view,
				const glm::mat4& proj, const glm::vec2& viewport);
