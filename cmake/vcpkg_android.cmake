...
if (VCPKG_TARGET_ANDROID)
    ...
    if (NOT DEFINED ENV{ANDROID_NDK_HOME})
        # Try to use ANDROID_NDK if it's defined
        if (DEFINED ANDROID_NDK)
            set(ENV{ANDROID_NDK_HOME} ${ANDROID_NDK})
            message(STATUS "Set ANDROID_NDK_HOME from ANDROID_NDK: ${ANDROID_NDK}")
        else()
            message(FATAL_ERROR "
    ...
    if (NOT DEFINED ENV{VCPKG_ROOT})
        # Try to set VCPKG_ROOT from system installation
        # set(VCPKG_ROOT "C:/vcpkg/vcpkg")
        if (EXISTS "${VCPKG_ROOT}/scripts/buildsystems/vcpkg.cmake")
            set(ENV{VCPKG_ROOT} ${VCPKG_ROOT})
            message(STATUS "Set VCPKG_ROOT from system installation: ${VCPKG_ROOT}")
        else()
            message(FATAL_ERROR "
